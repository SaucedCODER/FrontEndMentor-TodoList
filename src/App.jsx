...
function App() {
  ...
  return (
    <>
      ...
      <img className="absolute -z-5 w-full max-h-[100%] h-[250px] md:hidden" src={`/assets/${theme == 'light'?"bg-mobile-light":"bg-mobile-dark"}.jpg`} alt="header_IMG" />
      <img className="absolute -z-5 w-full max-h-[100%] h-[250px] hidden md:block" src={`/assets/${theme == 'light'?"bg-desktop-light":"bg-desktop-dark"}.jpg`} alt="header_IMG" />
      ...
      <div className='mx-auto px-8 pt-10 max-w-[550px]'>
        <div className='flex justify-between mb-10'>
          ...
          <img className="relative z-1 w-auto h-7" onClick={toggleTheme} src={`/assets/icon-${theme == 'light'?'moon':'sun'}.svg` } alt={theme+"icon"} />
        </div>
